% A template for a master's thesis, specifically for the MDP in Linguistic Data Sciences at the University of Eastern Finland
% This file contains only the cover page; the individual chapters are in different files
